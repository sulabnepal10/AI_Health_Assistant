...
export default function DashboardPage() {
  const stats = [
    { label: 'Summaries Today', value: '-', icon: CheckCircle, color: 'text-green-600' },
    { label: 'PHI Checks', value: '-', icon: Shield, color: 'text-red-600' },
    { label: 'Active Users', value: '-', icon: Activity, color: 'text-indigo-600' },
  ];
